...
export default function AleoSocialLinks() {
  const cardStyle =
    "flex flex-col md:flex-row justify-between items-center bg-[#121216] border border-white/10 rounded-[2rem] px-10 py-8 w-[420px] h-[200px] cursor-pointer hover:bg-[#EEFFA8]/10 transition";
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 flex-wrap">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center mt-6 md:mt-0">
            ...
            <p className="text-white font-semibold flex items-center gap-1">
              X.com <span className="text-[#EEFFA8]">⤴︎</span>
            </p>
          </div>
        </motion.a>
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center mt-6 md:mt-0">
            ...
            <p className="text-white font-semibold flex items-center gap-1">
              Discord <span className="text-[#EEFFA8]">⤴︎</span>
            </p>
          </div>
        </motion.a>
      </div>

      {/* === BOTTOM ROW: YouTube + GitHub === */}
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 flex-wrap">
        {/* YouTube */}
        <motion.a
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center mt-6 md:mt-0">
            ...
            <p className="text-white font-semibold flex items-center gap-1">
              GitHub <span className="text-[#EEFFA8]">⤴︎</span>
            </p>
          </div>
        </motion.a>
      </div>
