...
export default function AleoSocialLinks() {
  const cardStyle =
    "flex flex-col md:flex-row justify-between items-center bg-[#121216] border border-white/10 rounded-[2rem] px-10 py-8 w-[360px] h-[220px] cursor-pointer hover:bg-[#EEFFA8]/10 transition";
